...
INSERT INTO product(label, quantity, id_unit) VALUES('Sac à main', 338_000.0, 1);
-- Loyer
...
-- Charges supplétives
INSERT INTO section(no_account, label, id_unit, id_nature, id_incorporation) 
VALUES (NULL, 'Charges supplétives', 3, 2, 3);
...
VALUES ('613', 1, 'Loyer', 0, , '2024-09-30');

-- Amortissement
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6811', 1, 'Amortissement', 0, , '2024-09-30');

-- Cuir
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('601', 1, 'Cuir', 0, , '2024-09-30');

-- Salaire Admin
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6411', 1, 'Salaire Admin', 0, , '2024-09-30');

-- Assurances
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('616', 1, 'Assurances', 0, , '2024-09-30');

-- Charges supplétives
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES (NULL, 1, 'Charges supplétives', 0, , '2024-09-30');

-- Fils
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('601', 1, 'Fils', 0, , '2024-09-30');

-- Fermois
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('601', 1, 'Fermois', 0, , '2024-09-30');

-- Accessoires
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('606', 1, 'Accessoires', 0, , '2024-09-30');

-- Main d’œuvre directe
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6411', 1, 'Main d''oeuvre directe', 0, , '2024-09-30');

-- Eau et électricité
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6061', 1, 'Eau et électricité', 0, , '2024-09-30');

-- Entretien de communication
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6155', 1, 'Entretien de communication', 0, , '2024-09-30');

-- Impôts et taxes
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('635', 1, 'Impôts et taxes', 0, , '2024-09-30');

-- Charges personnels
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6411', 1, 'Charges personnels', 0, , '2024-09-30');

-- CNAPS et OSTIE
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('645', 1, 'CNAPS et OSTIE', 0, , '2024-09-30');

-- Frais de transport
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6241', 1, 'Frais de transport', 0, , '2024-09-30');

-- Emballage
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('6026', 1, 'Emballage', 0, , '2024-09-30');

-- Frais de communication
INSERT INTO exercice(no_account, id_exercice_year, label, credit, debit, date) 
VALUES ('626', 1, 'Frais de communication', 0, , '2024-09-30');


INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 1,  1, 1,  1_500_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 2,  2, 1,  3_000_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 3,  3, 1,  5_000_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 4,  4, 1,  2_500_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 5,  5, 1,  1_200_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 6,  6, 1,    500_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 7,  7, 1,  1_000_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 8,  8, 1,    800_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES( 9,  9, 1,    600_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(10, 10, 1,  4_000_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(11, 11, 1,  1_200_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(12, 12, 1,    300_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(13, 13, 1,  1_000_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(14, 14, 1,  2_500_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(15, 15, 1,    800_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(16, 16, 1,    700_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(17, 17, 1,    400_000.0, '2024-09-20');
INSERT INTO expense(id_section, id_exercice, quantity, price, date) VALUES(18, 18, 1,    500_000.0, '2024-09-20');
